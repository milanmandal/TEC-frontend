...
const QuestionCard = ({ questionDetails, index, currentUser, updateScore, questions, setScore , company, domain}) => {
    useEffect(() => {
    ...
    const { _id, question, } = questionDetails;
     ...
     const onSubmitMcqs = (e) => {
        ...
        if (respons) {
            ...
            const answer ={answer:respons.value}
             ...
             Axios.post(url+company+'/answer/'+domain+'/'+questionDetails._id+'/'+currentUser.currentUser._id, answer)
